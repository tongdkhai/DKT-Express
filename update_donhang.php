...
if (isset($_GET['id'])) {
    $id          = $_GET['id'];
    $sql         = 'select * from donhang where donhang.id = ' . $id;
    $donhang = executeResult($sql);
    if ($donhang != null && count($donhang) > 0) {
        $prd = $donhang[0];
        $name = $prd['name'];
        $price = $prd['price'];
        $Status = $prd['Status'];
...
if (isset($_POST['submit'])) {
    ...
    $sql = "update donhang set name = '$name', price = '$price', Status = '$Status', date = '$date' where id = " . $id;
    execute($sql);
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-10 text-center">
              <h1 class="m-0">Sửa thông tin đơn hàng</h1>
            </div><!-- /.col -->
            <div class="col-sm-2">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="col-6 input_group">
          ...
          <div class="col-6 input_group">
            ...
            <textarea name="price" id="input" class="form-control" rows="3" value="<?php echo $price; ?>"><?php echo $price; ?></textarea>
        </div>

        <div class="col-6 input_group">
            <label for="">Trạng thái</label>
            <textarea name="Status" id="input" class="form-control" rows="3" value="<?php echo $Status; ?>" ><?php echo $Status; ?></textarea>
        </div>

        <div class="col-6 input_group">
            <label for="">Thời gian</label>
            <textarea name="date" id="input" class="form-control" rows="3" value="<?php echo $date; ?>" ><?php echo $date; ?></textarea>
        </div>
<br><br>
