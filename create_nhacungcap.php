...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into nhacungcap(name) value ('$name')";
    execute($sql);
 ...
 <div class="wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-10 text-center">
              <h1 class="m-0">Thêm thông tin nhà cung cấp</h1>
            </div><!-- /.col -->
            <div class="col-sm-2">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-6 input_group">
            ...
            <textarea name="addres" id="input" class="form-control" rows="3" required="required"></textarea>
        </div>

        <div class="col-6 input_group">
            <label for="">Điện thoại</label>
            <textarea name="tel" id="input" class="form-control" rows="3" required="required"></textarea>
        </div>
<br><br>
