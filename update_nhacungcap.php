...
if (isset($_GET['id'])) {
	$id          = $_GET['id'];
	$sql         = 'select * from nhacungcap where nhacungcap.id = '.$id;
	$nhacungcap = executeResult($sql);
	if ($nhacungcap != null && count($nhacungcap) > 0) {
		$cat = $nhacungcap[0];
		$name = $cat['name'];
        $image = $cat['image'];
        $address = $cat['addres'];
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if (isset($_POST['name'])||isset($_POST['image'])||isset($_POST['addres'])||isset($_POST['Tel'])) {
            $name = $_POST['name'];
            // $image = $_POST['image'];
            $addres = $_POST['addres'];
            $Tel = $_POST['Tel'];
        }
        $sql = "update nhacungcap set name = '$name'  where id = " . $id;
        $sql = "update nhacungcap set image = '$image'  where id = " . $id;
        $sql = "update nhacungcap set addres = '$addres'  where id = " . $id;
        $sql = "update nhacungcap set Tel = '$Tel'  where id = " . $id;
        execute($sql);
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-10 text-center">
              <h1 class="m-0">Sửa thông tin nhà cung cấp</h1>
            </div><!-- /.col -->
            <div class="col-sm-2">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-6 input_group">
         ...
         <div class="col-6 input_group">
            ...
            <input type="text" name="addres" class="form-control" id="" value="<?php echo $addres ?>">
        </div>

         <div class="col-6 input_group">
            <label for="">Số điện thoại</label>
            <input type="text" name="Tel" class="form-control" id="" value="<?php echo $Tel ?>">
        </div>
<br><br>
