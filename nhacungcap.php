...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="wrapper">
    ...
    <tbody>
      ...
      $nhacungcapp = executeResult($sql);

      $index = 1;
      foreach ($nhacungcapp as $nhacungcap) {
        echo '<tr>
              <td>' . ($index++) . '</td>
              <td>' . $nhacungcap['name'] . '</td>
              <td><img width = 100px height= 100px src=' . $nhacungcap['image'] . ' ></td>
              <td>' . $nhacungcap['addres'] . '</td>
              <td>' . $nhacungcap['Tel'] . '</td>
              <td><button class="btn btn-success" onclick=\'window.open("update_nhacungcap.php?id=' . $nhacungcap['id'] . '","_self")\'>Sửa</button>
              <button class="btn btn-danger" onclick="deleteNhacungcap(' . $nhacungcap['id'] . ')">Xóa</button></td>
            </tr>';
      }
      ?>
    </tbody>
