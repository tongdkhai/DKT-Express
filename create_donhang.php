...
<?php
    if (isset($_POST['submit'])) {
        ...
        $sql = "insert into donhang(name, price, Status, date ) value ('$name', '$price', '$Status', '$date')";
        execute($sql);
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-10 text-center">
              <h1 class="m-0">Thêm thông tin đơn hàng</h1>
            </div><!-- /.col -->
            <div class="col-sm-2">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-6 input_group">
            ...
            <textarea name="price" id="input" class="form-control" rows="3" required="required"></textarea>
        </div>

        <div class="col-6 input_group">
            <label for="">Trạng thái</label>
            <textarea name="Status" id="input" class="form-control" rows="3" required="required"></textarea>
        </div>

        <div class="col-6 input_group">
            <label for="">Thời gian</label>
            <textarea name="date" id="input" class="form-control" rows="3" required="required"></textarea>
        </div>
